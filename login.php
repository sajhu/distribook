			...
			<div class="row-fluid">
				<div class="login-box">
					<div class="icons">
						...
						<a href="index.html#contactanos"><i class="halflings-icon info-sign"></i></a>
					</div>
					<h1 style="margin-left: 30px;">Inicio Sesión Distribook</h1>
					...
					<form class="form-horizontal" action="login.php?redirectTo=<?php echo $url;?>" method="post" >
						<fieldset>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="username" id="username" type="text" placeholder="Correo" />
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="password" id="password" type="password" placeholder="Clave" />
							</div>
							<div class="clearfix"></div>
<?php
	if($estado > 0)
